...
<aside id="sidebar"
    ...
    <div class="p-4 border-b border-white/10 flex-shrink-0">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="text-[#38bdf8] font-medium text-xs mt-0.5 tracking-wide uppercase">O'qituvchi kabineti</p>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto">
        ...
        <a href="<?= BASE_URL ?>/teacher/students/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/students/') !== false ? 'active' : '' ?>">
            <i class="nav-icon fas fa-user-graduate w-4 text-center"></i>
            <span>Talabalar</span>
        </a>

        <a href="<?= BASE_URL ?>/teacher/activity/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/activity/') !== false ? 'active' : '' ?>">
            <i class="nav-icon fas fa-chart-line w-4 text-center"></i>
            <span>Talaba faolligi</span>
        </a>

        <a href="<?= BASE_URL ?>/teacher/lectures/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/lectures/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/practicals/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/practicals/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/tests/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/tests/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/maps/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/maps/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/glossary/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/glossary/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/library/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/library/') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/teacher/laboratory/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/laboratory/') !== false ? 'active' : '' ?>">
            <i class="nav-icon fas fa-microscope w-4 text-center"></i>
            <span>Aholishunoslik lab.</span>
        </a>

        <a href="<?= BASE_URL ?>/teacher/results/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/results/') !== false ? 'active' : '' ?>">
            <i class="nav-icon fas fa-clipboard-check w-4 text-center"></i>
            <span>Test natijalari</span>
        </a>

        <a href="<?= BASE_URL ?>/teacher/reports/index.php"
           class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
                  <?= strpos($_SERVER['REQUEST_URI'], '/teacher/reports/') !== false ? 'active' : '' ?>">
