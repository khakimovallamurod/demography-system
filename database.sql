...
-- Laboratory Materials table
CREATE TABLE IF NOT EXISTS laboratory_materials (
    id INT AUTO_INCREMENT PRIMARY KEY,
    category_id INT NOT NULL COMMENT '1:Instructions, 2:Capabilities, 3:Resources, 4:Rules, 5:Sites, 6:Videos',
    title VARCHAR(255) NOT NULL,
    description TEXT,
