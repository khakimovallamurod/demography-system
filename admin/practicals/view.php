...
if (!$practical || !file_exists(__DIR__ . '/../../' . $practical['file_path'])) {
    die_with_swal("Topilmadi", "Fayl topilmadi yoki o'chirilgan.");
}

$pdfUrl = BASE_URL . '/' . $practical['file_path'];
$page_title = $practical['title'] . " - Ko'rish";
include __DIR__ . '/../../includes/admin_header.php';
?>

<div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <h2 class="text-xl font-bold text-gray-800 line-clamp-1"><?= h($practical['title']) ?></h2>
    </div>
    <div class="flex items-center gap-2">
        <a href="<?= BASE_URL ?>/admin/practicals/index.php" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-4 py-2.5 rounded-xl text-sm font-medium transition shadow-sm flex items-center gap-2">
