...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
        <a href="<?= BASE_URL ?>/admin/library/index.php" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-4 py-2.5 rounded-xl text-sm font-medium transition shadow-sm flex items-center gap-2">
