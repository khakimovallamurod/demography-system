...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            ...
            if ($id) {
                flash_message('success', "Ma'ruza muvaffaqiyatli qo'shildi!");
...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-lg font-semibold text-gray-800">Yangi ma'ruza qo'shish</h2>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="2"
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
            ...
            <div>
                ...
                <textarea name="content" rows="10"
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                    placeholder="Ma'ruza matni..."><?= h($_POST['content'] ?? '') ?></textarea>
            </div>
