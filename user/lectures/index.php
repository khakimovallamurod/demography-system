...
foreach ($lectures as &$l) {
    $l['is_read'] = in_array($l['id'], $read_lectures);
    $l['is_completed'] = in_array($l['id'], $completed_lectures);
...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500 mt-1">Demografiya bo'yicha barcha ma'ruzalar to'plami</p>
</div>
