...
$yoriqnoma_link = $yoriqnoma_item && !empty($yoriqnoma_item['file_path']) ? BASE_URL . '/teacher/laboratory/view.php?id=' . $yoriqnoma_item['id'] : '#';
?>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group">
        ...
        <div class="p-6 flex flex-col flex-grow text-center">
            ...
            <hr class="border-gray-100 mb-5">
            <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=2" class="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all text-sm mx-auto min-w-[140px]">
                Ko'rish
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group">
        ...
        <div class="p-6 flex flex-col flex-grow text-center">
            ...
            <hr class="border-gray-100 mb-5">
            <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=3" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all text-sm mx-auto min-w-[140px]">
                O'qish
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group">
        ...
        <div class="p-6 flex flex-col flex-grow text-center">
            ...
            <hr class="border-gray-100 mb-5">
            <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=4" class="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all text-sm mx-auto min-w-[140px]">
                Bilish
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group">
        ...
        <div class="p-6 flex flex-col flex-grow text-center">
            ...
            <hr class="border-gray-100 mb-5">
            <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=5" class="bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all text-sm mx-auto min-w-[140px]">
                Integratsiya
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group">
        ...
        <div class="p-6 flex flex-col flex-grow text-center">
            ...
            <hr class="border-gray-100 mb-5">
            <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=6" class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all text-sm mx-auto min-w-[140px]">
                Tomosha qilish
            </a>
        </div>
    </div>
