...
<div class="mb-4 flex items-center justify-between">
    ...
    <a href="<?= BASE_URL ?>/teacher/laboratory/category.php?id=<?= $item['category_id'] ?>" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium transition shadow-sm flex items-center gap-2 whitespace-nowrap">
